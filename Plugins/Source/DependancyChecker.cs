        ...
        public void Start()
        {
            ...
            if (dependancyAssembly != null)
            {
                ...
                if (dependancyAssemblyVersion < minimalAssemblyVersion)
                {
                    ...
                    PopupDialog.SpawnPopupDialog(new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f), currentModName + "/" + assemblyName + " Version mismatch", sb.ToString(), "OK", false, HighLogic.UISkin);
                }
            }
            else if (checkPresence)
            {
                ...
                PopupDialog.SpawnPopupDialog(new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f), assemblyName + " not found !", sb.ToString(), "OK", false, HighLogic.UISkin);
            }
        }
    }
}
